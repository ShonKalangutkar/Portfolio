...
const Developer = ({ animationName = "Idle", ...props }) => {
  ...
  // Load FBX animation (make sure this file actually contains animation)
  const idleAnimation = useFBX("/models/human/Developer.fbx");

  // Rename animation safely
  if (idleAnimation.animations.length > 0) {
    idleAnimation.animations[0].name = "Idle";
  }

  // Bind animation to model
