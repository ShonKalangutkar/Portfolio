...
const DemoComputer = (props) => {
  ...
  //   Ensure the texture is correctly oriented for the monitor-screen mesh
  useEffect(() => {
    if (txt) {
      txt.flipY = false;
    }
  ...
  }, { dependencies: [props.texture], scope: group });
    ...
    <group ref={group} {...props} dispose={null}>
      <group name="Scene">
        <mesh
          ...
          /* REMOVE THIS: material={nodes['monitor-screen'].material} */
